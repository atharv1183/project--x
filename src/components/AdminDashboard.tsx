...
const LOCATION_MAP: Record<string, string[]> = {
  ...
  "Goa": ["Panaji", "Margao", "Vasco da Gama", "Mapusa", "Ponda", "Bicholim", "Curchorem", "Sanquelim", "Calangute", "Candolim", "Pernem", "Quepem", "Canacona", "Valpoi", "Cuncolim", "Cansaulim", "Colva", "Benaulim", "Mormugao", "Cortalim", "Fatorda", "Navelim", "Raia", "Loutolim", "Aldona", "Anjuna", "Vagator", "Chapora"],
  ...
  "Karnataka": ["Bengaluru", "Mysuru", "Hubballi", "Mangaluru", "Belagavi", "Kalaburagi", "Ballari", "Vijayapura", "Shivamogga", "Tumkuru", "Davangere", "Udupi", "Dharwad", "Bidar", "Raichur", "Gadag", "Haveri", "Hosapete", "Bhadravati", "Robertsonpet", "Gangawati", "Bagalkote", "Koppal", "Yadgir", "Chitradurga", "Chikkaballapur", "Kolar", "Ramanagara", "Hassan", "Mandya", "Chikkamagaluru", "Kodagu", "Karwar", "Sirsi", "Kundapura", "Puttur", "Sullia", "Bantval", "Moodbidri", "Madikeri", "Virajpet", "Holenarasipura", "Sakleshpur", "Arsikere", "Channarayapatna", "Nagamangala", "Srirangapatna", "Maddur", "Pandavapura", "Krishnarajapet", "Kunigal", "Tiptur", "Chikkanayakanahalli", "Sira", "Pavagada", "Madhugiri", "Doddaballapur", "Nelamangala", "Devanahalli", "Chintamani", "Sidlaghatta", "Mulbagal", "Srinivasapur", "Gundlupet", "Chamarajanagar", "Kollegal", "Nanjangud", "Hunsur", "Periyapatna", "KR Nagar", "Belur", "Alur"],
  "Kerala": ["Thiruvananthapuram", "Kochi", "Kozhikode", "Kollam", "Thrissur", "Palakkad", "Alappuzha", "Malappuram", "Kannur", "Kottayam", "Kasaragod", "Pathanamthitta", "Idukki", "Wayanad", "Ernakulam", "Manjeri", "Thalassery", "Ponnani", "Vatakara", "Thrippunithura", "Kayamkulam", "Punalur", "Changanacherry", "Kanhangad", "Perinthalmanna", "Attingal", "Neyyattinkara", "Irinjalakuda", "Kodungallur", "Guruvayur", "Kunnamkulam", "Ottapalam", "Shoranur", "Mannarkkad", "Tirur", "Tiruvalla", "Adoor", "Pandalam", "Karunagappally", "Varkala", "Chirayinkeezhu", "Nedumangad", "Aroor", "Cherthala", "Parippally", "Paravur", "Kalamassery", "Perumbavoor", "Muvattupuzha", "Kothamangalam", "Angamaly", "Chalakudy", "Piravom", "Pala", "Ettumanoor", "Vaikom", "Kottarakkara", "Maradu", "Eloor", "Aluva"],
  "Madhya Pradesh": ["Bhopal", "Indore", "Jabalpur", "Gwalior", "Ujjain", "Sagar", "Ratlam", "Satna", "Murwara", "Dewas", "Chhindwara", "Rewa", "Singrauli", "Burhanpur", "Khandwa", "Morena", "Bhind", "Guna", "Shivpuri", "Vidisha", "Damoh", "Mandsaur", "Khargone", "Neemuch", "Pithampur", "Hoshangabad", "Itarsi", "Sehore", "Betul", "Seoni", "Balaghat", "Datia", "Tikamgarh", "Chhatarpur", "Panna", "Shahdol", "Anuppur", "Umaria", "Dindori", "Mandla", "Narsinghpur", "Raisen", "Rajgarh", "Ashoknagar", "Barwani", "Alirajpur", "Jhabua", "Dhar", "Agar Malwa", "Niwari", "Sheopur", "Sidhi", "Katni", "Maihar", "Nagda", "Mhow", "Depalpur", "Sanawad", "Sendhwa", "Maheshwar", "Mandleshwar", "Harda", "Timarni", "Shujalpur", "Shajapur", "Agar", "Susner", "Pachore"],
  "Maharashtra": ["Mumbai", "Pune", "Nagpur", "Nashik", "Thane", "Aurangabad", "Solapur", "Amravati", "Navi Mumbai", "Kolhapur", "Akola", "Latur", "Dhule", "Chandrapur", "Jalgaon", "Sangli", "Satara", "Ratnagiri", "Sindhudurg", "Osmanabad", "Nanded", "Parbhani", "Hingoli", "Buldhana", "Washim", "Yavatmal", "Wardha", "Gadchiroli", "Gondia", "Bhandara", "Ahmednagar", "Bid", "Jalna", "Raigad", "Palghar", "Malegaon", "Mira-Bhayandar", "Vasai-Virar", "Bhiwandi", "Kalyan", "Ulhasnagar", "Ambarnath", "Badlapur", "Panvel", "Ichalkaranji", "Miraj", "Karad", "Pandharpur", "Barshi", "Tuljapur", "Wai", "Phaltan", "Vita", "Tasgaon", "Shirdi", "Kopargaon", "Rahuri", "Sangamner", "Shrirampur", "Nevasa", "Parner", "Pathardi", "Shevgaon", "Risod", "Mangrulpir", "Malkapur", "Mehkar", "Lonar", "Khamgaon", "Chikhli", "Nandura", "Motala", "Jalgaon Jamod", "Sindkhed Raja", "Deulgaon Raja", "Ambad", "Parli", "Georai", "Majalgaon", "Kaij", "Dharur", "Ausa", "Udgir", "Ahmedpur", "Mukhed", "Deglur", "Biloli", "Hadgaon", "Kinwat", "Bhokar", "Loha", "Kandhar", "Wani", "Kelapur", "Ralegaon", "Digras", "Pusad", "Umarkhed", "Darwha", "Ner", "Ghatanji", "Yeotmal", "Sawner", "Katol", "Narkhed", "Kalmeshwar", "Ramtek", "Umred", "Tumsar", "Sakoli", "Tirora", "Sadak Arjuni", "Arjuni Morgaon", "Amgaon", "Deori", "Chimur", "Bramhapuri", "Mul", "Ballarpur", "Warora", "Nagbhid", "Sironcha", "Etapalli", "Dhanora", "Chamorshi", "Chiplun", "Sawantwadi", "Khed", "Guhagar", "Dapoli", "Mandangad", "Alibag", "Pen", "Khopoli", "Mahad", "Poladpur", "Mangaon", "Roha", "Murud", "Shrivardhan", "Mhasala"],
  ...
  "Meghalaya": ["Shillong", "Tura", "Nongstoin", "Jowai", "Baghmara", "Resubelpara", "Ampati", "Mairang", "Nongpoh", "Khliehriat", "Williamnagar", "Mawkyrwat", "Dadengiri", "Sangram", "Amlarem", "Cherrapunji", "Mawsynram", "Dawki", "Byrnihat"],
  ...
  "Odisha": ["Bhubaneswar", "Cuttack", "Rourkela", "Brahmapur", "Sambalpur", "Puri", "Balasore", "Bhadrak", "Baripada", "Jharsuguda", "Bargarh", "Bolangir", "Sundargarh", "Dhenkanal", "Kendrapara", "Jagatsinghpur", "Jajpur", "Khordha", "Nayagarh", "Ganjam", "Gajapati", "Kandhamal", "Boudh", "Subarnapur", "Angul", "Deogarh", "Kalahandi", "Nuapada", "Rayagada", "Koraput", "Nabarangpur", "Malkangiri", "Kendujhar", "Mayurbhanj", "Aska", "Phulbani", "Titilagarh", "Patnagarh", "Bhawanipatna", "Bonai", "Keonjhar", "Barbil", "Champua", "Anandapur", "Jajpur Road", "Dharmasala", "Paradeep", "Ersama", "Nimapara", "Pipili", "Bhuban", "Kamakhyanagar", "Hindol", "Tumudibandha", "Balliguda", "Sonepur", "Binka", "Tarbha", "Khariar", "Sinapali"],
  "Punjab": ["Ludhiana", "Amritsar", "Jalandhar", "Patiala", "Bathinda", "Pathankot", "Hoshiarpur", "Mohali", "Batala", "Gurdaspur", "Moga", "Firozpur", "Fazilka", "Muktsar", "Faridkot", "Mansa", "Barnala", "Sangrur", "Fatehgarh Sahib", "Ropar", "Nawanshahr", "Tarn Taran", "Kapurthala", "Rajpura", "Phagwara", "Abohar", "Malerkotla", "Khanna", "Morinda", "Zirakpur", "Kharar", "Anandpur Sahib", "Nangal", "Rupnagar", "Sirhind", "Mandi Gobindgarh", "Samana", "Nabha", "Sunam", "Dhuri", "Lehragaga", "Bareta", "Rampura Phul", "Talwandi Sabo", "Kot Kapura", "Zira", "Ferozepur Cantt", "Jalalabad", "Giddarbaha", "Tapa", "Dhanaula", "Baba Bakala"],
  "Rajasthan": ["Jaipur", "Jodhpur", "Udaipur", "Kota", "Bikaner", "Ajmer", "Bhilwara", "Alwar", "Sri Ganganagar", "Bharatpur", "Sikar", "Pali", "Tonk", "Sawai Madhopur", "Nagaur", "Hanumangarh", "Churu", "Jhunjhunu", "Barmer", "Jaisalmer", "Jalore", "Sirohi", "Bundi", "Baran", "Jhalawar", "Karauli", "Dholpur", "Dausa", "Rajsamand", "Dungarpur", "Banswara", "Chittorgarh", "Pratapgarh", "Abu Road", "Beawar", "Kishangarh", "Makrana", "Nawa", "Suratgarh", "Raisinghnagar", "Padampur", "Karanpur", "Anoopgarh", "Vijainagar", "Tibbi", "Sadulshahar", "Rawatsar", "Nohar", "Bhadra", "Sangaria", "Pilibanga", "Sujangarh", "Sardarshahar", "Ratangarh", "Taranagar", "Rajgarh", "Dungargarh", "Bidasar", "Salasar", "Fatehpur", "Laxmangarh", "Nawalgarh", "Mukundgarh", "Bissau", "Mandawa", "Pilani", "Chirawa", "Khetri", "Shahpura", "Reengus", "Neem ka Thana", "Srimadhopur", "Khandela", "Udaipurwati"],
  ...
  "Tamil Nadu": ["Chennai", "Coimbatore", "Madurai", "Tiruchirappalli", "Salem", "Tirunelveli", "Tiruppur", "Vellore", "Erode", "Thanjavur", "Dindigul", "Ranipet", "Thoothukudi", "Nagercoil", "Kanchipuram", "Hosur", "Kumbakonam", "Cuddalore", "Villupuram", "Krishnagiri", "Dharmapuri", "Namakkal", "Karur", "Pudukkottai", "Sivaganga", "Ramanathapuram", "Virudhunagar", "Theni", "Ooty", "Pollachi", "Mettur", "Ambur", "Vaniyambadi", "Arani", "Tiruvallur", "Gummidipoondi", "Tambaram", "Avadi", "Pallavaram", "Kalpakkam", "Maraimalai Nagar", "Chengalpattu", "Madurantakam", "Uttiramerur", "Tindivanam", "Gingee", "Tiruvannamalai", "Polur", "Vandavasi", "Cheyyar", "Thirukoilur", "Kallakurichi", "Sankarapuram", "Ulundurpet", "Panruti", "Neyveli", "Chidambaram", "Sirkazhi", "Mayiladuthurai", "Nagapattinam", "Vedaranyam", "Papanasam", "Needamangalam", "Mannargudi", "Thiruthuraipoondi", "Pattukkottai", "Arantangi", "Alangudi", "Karaikudi", "Devakottai", "Rajapalayam", "Srivilliputhur", "Sattur", "Sivakasi", "Kovilpatti", "Tiruchendur", "Kayalpatnam", "Ottapidaram", "Sankarankovil", "Tenkasi", "Shencottai", "Kadayanallur", "Ambasamudram", "Palayamkottai", "Vallioor", "Nanguneri", "Cheranmahadevi", "Thisayanvilai"],
  "Telangana": ["Hyderabad", "Warangal", "Nizamabad", "Khammam", "Karimnagar", "Ramagundam", "Mahbubnagar", "Nalgonda", "Adilabad", "Suryapet", "Medak", "Sangareddy", "Siddipet", "Yadadri Bhuvanagiri", "Jagitial", "Rajanna Sircilla", "Peddapalli", "Jayashankar Bhupalpally", "Mulugu", "Bhadradri Kothagudem", "Asifabad", "Mancherial", "Nirmal", "Kamareddy", "Vikarabad", "Wanaparthy", "Gadwal", "Nagarkurnool", "Narsampet", "Mahabubabad", "Jangaon", "Narayanpet", "Medchal", "Ranga Reddy", "Shamshabad", "Tandur", "Pargi", "Chevella", "Shadnagar", "Farooqnagar", "Kothur", "Maheshwaram", "Ibrahimpatnam", "Hayathnagar", "Bodhan", "Armur", "Banswada", "Yellareddy", "Koratla", "Metpally", "Jagtial", "Dharmapuri", "Manthani", "Godavarikhani", "Sultanabad", "Bhupalpally", "Palimela", "Sattupally", "Madhira", "Wyra", "Kothagudem", "Bhadrachalam", "Manuguru", "Pinapaka", "Yellandu", "Dornakal", "Mahbubabad", "Parkal", "Wardhannapet", "Nekkonda", "Thorrur", "Gudur", "Miryalaguda", "Huzurnagar", "Nakrekal", "Devarakonda", "Korutla", "Sircilla", "Vemulawada"],
